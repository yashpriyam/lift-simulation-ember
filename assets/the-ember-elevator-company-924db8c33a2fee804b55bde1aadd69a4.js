...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("the-ember-elevator-company/app").default.create({name:"the-ember-elevator-company",version:"0.0.0+7e6b490c"})
